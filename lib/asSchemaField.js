      ...
      _this.onChangeValidate = function (val, e) {
        ...
        if (_this.props.form.schema && _this.props.form.schema.type.match(/integer|number/) && typeof value !== 'number') {
          if (!value || e.type === 'blur') {
            ...
            if (value.indexOf('.') === -1 || _this.props.form.schema.type.match(/integer/)) {
        ...
        } else if (val.target && _this.props.form.schema && _this.props.form.schema.type === 'boolean') {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        if ((typeof error === 'undefined' ? 'undefined' : _typeof(error)) === 'object') {
          ...
          error = (0, _validate.getValidationMesage)(error, form, model, value);
        }
