  ...
  _createClass(Fieldset, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          form = _props.form,
          model = _props.model,
          mapper = _props.mapper; // eslint-disable-line no-unused-vars
      ...
      var fields = form.items.map(function (formField, index) {
        return _this2.props.builder(formField, _this2.props.model, index, _this2.props.onChange, _this2.props.mapper, _this2.props.builder);
      });
