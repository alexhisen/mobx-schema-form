...
var _switch = require('react-toolbox/lib/switch');
...
var SwitchField = function SwitchField(props) {
  var formField = props.formField,
      value = props.value,
      error = props.error,
      others = _objectWithoutProperties(props, ['formField', 'value', 'error']); // eslint-disable-line no-unused-vars


  var trueLabel = void 0;
  var falseLabel = void 0;
  ...
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(_switch2.default, _extends({}, others, {
      checked: !!value,
...
exports.default = (0, _asSchemaField2.default)(SwitchField);
