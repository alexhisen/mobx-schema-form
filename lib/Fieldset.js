...
var Fieldset = (0, _mobxReact.observer)(_class = function (_React$Component) {
  ...
  _createClass(Fieldset, [{
    ...
    value: function render() {
      ...
      if (this.props.form.mobxCondition && eval(this.props.form.mobxCondition) === false) {
      ...
      var fields = this.props.form.items.map(function (form, index) {
        return _this2.props.builder(form, _this2.props.model, index, _this2.props.onChange, _this2.props.mapper, _this2.props.builder);
      });
