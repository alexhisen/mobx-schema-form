  ...
  return (0, _mobxReact.observer)((_temp = _class = function (_React$Component) {
    ...
    function _class(props) {
      ...
      _this.onChangeValidate = function (val, e) {
        ...
        } else if (val && val.target && _this.props.form.schema && _this.props.form.schema.type === 'boolean') {
      ...
      _this.onBlur = function (e) {
        if (_this.props.form.type.match(/text|textarea|email|tel|number|password/i)) {
          ...
          if (value || _this.initialValue) {
            var trimmed = value.trim();

            if (value !== trimmed || !_this.valueEntered || _this.initialValue || _this.state.valueAsString) {
              _this.valueEntered = true;
    ...
    _createClass(_class, [{
      ...
      value: function componentWillUnmount() {
        ...
        var key = this.getKey();
        var hasError = !!_reactSchemaForm.utils.selectOrSet(key, this.props.model.dataErrors);
        if (hasError && this.props.model.getSavedData) {
          // reset the field to known good value and clear the validation error on the field
          (0, _mobx.action)(function () {
            var value = _reactSchemaForm.utils.selectOrSet(key, _this3.props.model.getSavedData());
            _reactSchemaForm.utils.selectOrSet(key, _this3.props.model.data, value);
            _reactSchemaForm.utils.selectOrSet(key, _this3.props.model.dataErrors, null);
      ...
      value: function render() {
        ...
        var error = _reactSchemaForm.utils.selectOrSet(this.getKey(), model.dataErrors);
