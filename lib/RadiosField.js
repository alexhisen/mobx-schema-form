...
var RadiosField = function RadiosField(props) {
  var formField = props.formField,
      value = props.value,
      name = props.name,
      others = _objectWithoutProperties(props, ['formField', 'value', 'name']);

  var items = (formField.titleMap || formField.schema.enum).map(function (item) {
    return _react2.default.createElement(_radio.RadioButton, {
      name: name,
...
exports.default = (0, _asSchemaField2.default)(RadiosField);
