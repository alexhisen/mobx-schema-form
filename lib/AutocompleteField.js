...
AutocompleteField.propTypes = {
  ...
  value: _propTypes2.default.oneOfType([_propTypes2.default.arrayOf([_propTypes2.default.string, _propTypes2.default.number]), _propTypes2.default.string, _propTypes2.default.number])
};
