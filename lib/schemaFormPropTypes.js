...
var formShape = exports.formShape = _propTypes2.default.shape({
  ...
  mobxCondition: _propTypes2.default.string,
  requiredCondition: _propTypes2.default.string,
  readOnlyCondition: _propTypes2.default.string,
  ...
  mask: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.arrayOf(_propTypes2.default.any)]), // array is for future versions of React-Input-Mask
  maskProps: _propTypes2.default.object, /* props passed as-is to the React-Input-Mask component */
...
var modelShape = exports.modelShape = _propTypes2.default.shape({
  ...
  status: _propTypes2.default.shape({
    ...
    mustCreate: _propTypes2.default.bool
  }),
