...
var DropdownField = function DropdownField(props) {
  var formField = props.formField,
      others = _objectWithoutProperties(props, ['formField']);

  var titleMap = formField.titleMap.map(function (item) {
    return item.name ? { label: item.name, value: item.value, group: item.group } : item;
  });
...
exports.default = (0, _asSchemaField2.default)(DropdownField, 'dropdown');
