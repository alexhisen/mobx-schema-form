      ...
      if (value === undefined) {
        ...
        if (formField.falseConditionValue !== undefined && formField.condition && eval(formField.condition) === false) {
          (0, _mobx.action)(function () {
            var fieldKey = (0, _validate.getFieldKey)(formField);
            _utils2.default.selectOrSet(fieldKey, _this.props.model.data, formField.falseConditionValue);
            _utils2.default.selectOrSet(fieldKey, _this.props.model.dataErrors, null);
          })();
        }
        /* eslint-enable */
