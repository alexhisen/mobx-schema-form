  ...
  _createClass(AutocompleteField, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = _objectWithoutProperties(_props, ['formField', 'onChange']); // eslint-disable-line no-unused-vars
      ...
      var multiple = formField.type === 'multiselect' || formField.schema.type === 'array';
      if (value === null) {
        value = multiple ? [] : '';
      }
