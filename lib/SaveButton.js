  ...
  function SaveButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SaveButton.__proto__ || Object.getPrototypeOf(SaveButton)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (e) {
      return new Promise(function ($return, $error) {
        ...
        return (0, _validate.validateAndSave)(this.props.model, this.props.options, e).then(function ($await_1) {
          isValid = $await_1;
  ...
  _createClass(SaveButton, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = _objectWithoutProperties(_props, ['model', 'options', 'disabled', 'onClick', 'onSave', 'onInvalid']); // eslint-disable-line no-unused-vars
...
SaveButton.propTypes = {
  ...
  options: _react2.default.PropTypes.shape({
    ...
    saveAll: _react2.default.PropTypes.bool,
    skipPropertyBeingEdited: _react2.default.PropTypes.bool,
    keepServerError: _react2.default.PropTypes.bool
  }),
